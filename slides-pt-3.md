...
<pre class="code-wrapper" data-id="code-animation">
  <code class="language-yml" data-line-numbers="|2-22|23-38|39-57|58-114|115-136|138-151|152-159|160-191" data-trim> 
footer:
  nav:
    - title: What We Do
      links:
...
Notes:
Our footer YAML is processed a little differently - we generate all the HTML for the footer first, then include that within the JSON. This escaped HTML gets included in the MFEs + theme at build time.
